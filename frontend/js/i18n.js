...
export const translations = {
            zh: {
                ...
                tbEmpty: "今天没有待办 🌱",
                tbCountdownMin: "{n}分钟",
                tbCountdownHour: "{n}小时",
                tbCountdownDay: "{n}天",
                buddyLinesCalm: ["准备好学习了吗？", "我在这里陪着你。"],
                buddyLinesHappy: ["今天状态不错哦！", "我们继续保持吧！"],
                buddyLinesExcited: ["感觉超棒的！一起冲刺！", "势头正好，别停下来！"],
                remindersLabel: "🔔 截止提醒",
                remindersCompanionHint: "开启后 Buddy 会：晨间简报当天安排 · 截止前 2 小时/30 分钟提醒（可稍后）· 逾期温柔提示改期 · 夜间 22:00–07:00 免打扰。",
                ...
                reminderSnoozeBtn: "稍后 15 分钟",
                briefToday: "{salutation}，今天有 {count} 件待办，最紧的是「{title}」{time} 截止 🌱",
                briefNoneToday: "{salutation}，今天没有待办安排，好好休息一下 🌱",
                overdueCheckin: "「{title}」已经过了截止时间，没关系～要不要重新安排一下？",
                overdueRescheduleBtn: "改期",
                settingsSave: "保存",
            ...
            en: {
                ...
                tbOverdue: "Overdue",
                tbNextDue: "Next due",
                tbEmpty: "Nothing due today 🌱",
                tbCountdownMin: "{n} min",
                tbCountdownHour: "{n} hr",
                tbCountdownDay: "{n} d",
                ...
                remindersLabel: "🔔 Deadline reminders",
                remindersCompanionHint: "Once on, Buddy gives a morning brief, nudges 2h/30min before due (snoozable), gently offers to reschedule overdue tasks, and stays quiet 22:00–07:00.",
                ...
                reminderSnoozeBtn: "Snooze 15 min",
                briefToday: "{salutation} You have {count} task(s) today — soonest is \"{title}\" at {time} 🌱",
                briefNoneToday: "{salutation} Nothing due today — take it easy 🌱",
                overdueCheckin: "\"{title}\" is past due — no worries, want to pick a new time?",
                overdueRescheduleBtn: "Reschedule",
                settingsSave: "Save",
...
export function applyLanguage() {
            ...
            // Re-render the Today band's dynamic content (greeting, task titles,
            // pill labels) in the new language.
